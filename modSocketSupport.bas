...
Public Sub AddToLog(ByVal sMsg As String)

    Dim lFhndl      As Long
        
    lFhndl = FreeFile
    Open App.Path + "\Loggfile.txt" For Append As #lFhndl
        Print #lFhndl, sMsg
    Close #lFhndl
...
Private Function WindowProc(ByVal hwnd As Long, ByVal uMsg As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
    ...
    'WSAAsyncSelect function was called for, and the messages
    ...
    ElseIf uMsg = m_lngResolveMessage Then  'Modified: 04-MAR-2002
        ...
        '
        'Remove the items from the collections
